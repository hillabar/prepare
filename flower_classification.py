...
from keras.layers import RepeatVector, Dense, Conv2D, Flatten, Reshape, MaxPooling2D, Cropping2D, Activation
...
model_hist = model.fit_generator(train_gen, steps_per_epoch=t_steps, epochs= 100 , validation_data=valid_gen, validation_steps=v_steps)
